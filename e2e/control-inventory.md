...
| `/app/invites` | Invitations page or role redirect | `app-invites-page app-page-action-bar` text `Invitations`, or workspace-access heading | InvitesPageComponent / ownerHrRouteGuard | `/app/invites` or `/app/workspace-access` | No | Owner/HR | BLOCKED | Credentials unavailable; role-conditional |
